...
\begin{center}
	\begin{tabular}{ | p{2cm} | c | c | p{5cm} |}
		\hline
		\textbf{OSI Layer} & \textbf{Width} & \textbf{Description} \\
		\hline
  	Application & 1 &  Reset, active low \\
  	\hline
		Presentation & 1 & Syscp, @ 12MHz \\
		\hline
		Session & 1 & Unbounced Input \\
		\hline
		Transport & 1 & Debounced Output \\
		\hline
		Network & 1 & Debounced Output \\
		\hline
		Data Link & 1 & Debounced Output \\
		\hline
		Physical & 1 & Debounced Output \\
		\hline
	\end{tabular}
\end{center}
