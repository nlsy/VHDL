...
This module debounces three incomming signals into unbounced pulsed signals.
\begin{figure}[h]
	\centering	
...
This module works as a flipflop. Every time it gets a impulse the output toggles.
\begin{figure}[h]
	\centering	
...
This module generates an 1Hz signal as well as an 9600Hz baud rate.
\begin{figure}[h]
	\centering
...
This module handles the debounced and pulsed sensor inputs and detects the events.
\begin{figure}[h]
	\centering	
...
This module stores the current number of people in the room. It increments or decrements the number if needed. Additionally it indecates if min or max number of people is reached.
\begin{figure}[h]
	\centering	
...
This module controls the whole system and decides what to do next.
\begin{figure}[h]
	\centering	
...
This module connects the IC\_S4 to a PC via the RS232. It uses a 9600 baud rate, 8 bit, no parity and 1 stop bit.
\begin{figure}[h]
	\centering	
...
\subsection{utfsm: Finite State Machine for UART}
\begin{figure}[h]
	\centering	
...
\subsection{iffsm: Finite State Machine for Interface to S3}
\begin{figure}[h]
	\centering	
