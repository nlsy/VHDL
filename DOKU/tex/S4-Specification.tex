...
\begin{center}
	\begin{tabular}{ | p{2cm} | c | c | p{5cm} |}
	  ...
	  \hline
		...
		\hline
		\hline	
		tog\_s & SIGNAL & 1  & Toggeling signal \\
		\hline
	\end{tabular}
\end{center}
...
\begin{center}
	...
	\hline
	div\_cnt & integer & 1.25k/12M & Clock cycle durations \\	
	\hline
	\end{tabular}
\end{center}
...
\begin{center}
	\begin{tabular}{ | p{2cm} | c | c | p{5cm} |}
  	...
  	\hline
		...
		\hline	
		sel\_s & SIGNAL & [3:0] & Select mutliplexer \\
		\hline 
...
\begin{center}
	\begin{tabular}{ | p{2cm} | c | c | p{5cm} |}
  	...
  	\hline
		...
		nxt\_s & SIGNAL & 1 & Next Bit \\
		\hline
		sel\_s & SIGNAL & [4:0] & Select mutliplexer \\
		\hline
